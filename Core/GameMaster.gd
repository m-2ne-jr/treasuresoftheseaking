...
const MAIN_SCENE = preload("uid://dy6ak3imx5uxf")
const UI_ROOT = preload("uid://j2gn0yxv0umb")
...
func increase_goal_level():
	...
	SoundManager.play_sound(SoundManager.SFX_LIB[SoundManager.SFX_LIST.SFX_GOAL_REACHED], true)
